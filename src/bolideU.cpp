...
{  if (!Enabled) return &OutRangeData;
...
void xTimer::Converter()
{
   ...
   if (ss.Position("JAN")>=0) month = 1; else
   if (ss.Position("FEB")>=0) month = 2; else
   if (ss.Position("MAR")>=0) month = 3; else
   if (ss.Position("APR")>=0) month = 4; else
   if (ss.Position("MAY")>=0) month = 5; else
   if (ss.Position("JUN")>=0) month = 6; else
   if (ss.Position("JUL")>=0) month = 7; else
   if (ss.Position("AUG")>=0) month = 8; else
   if (ss.Position("SEP")>=0) month = 9; else
   if (ss.Position("OCT")>=0) month =10; else
   if (ss.Position("NOV")>=0) month =11; else
   if (ss.Position("DEC")>=0) month =12;
